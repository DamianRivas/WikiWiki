...
RSpec.describe WikisController, type: :controller do
  ...
  context "guest user" do
    ...
    describe "GET #new" do
      it "redirects guest users to the login screen" do
        get :new
    ...
    describe "POST #create" do
      it "redirects guest users to the login screen" do
        post :create, params: { wiki: { title: RandomData.random_word, body: RandomData.random_paragraph, user: user } }
  ...
  context "standard user doing CRUD on wikis they created" do
    before do
      sign_in user
    end
    ...
    describe "POST #create" do
      it "increases the number of wikis by 1" do
        expect { post :create, params: { wiki: { title: RandomData.random_word, body: RandomData.random_paragraph, user: user } } }.to change(Wiki, :count).by(1)
      end
      
      it "it assigns the new wiki to @wiki" do
        post :create, params: { wiki: { title: RandomData.random_word, body: RandomData.random_paragraph, user: user } }
  ...
  context "standard user doing CRUD on wikis they did not create" do
    before do
